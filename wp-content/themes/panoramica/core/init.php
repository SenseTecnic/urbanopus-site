...
function cpotheme_setup(){
	//Set core variables
	cpotheme_update_option('cpo_core_version', '1.7.0');
...
function cpotheme_scripts_front( ){
	...
	wp_enqueue_script('cpotheme_jquery_flexslider', $scripts_path.'jquery-flexslider.js');
...
function cpotheme_add_styles(){
	...
	if(cpotheme_get_option('cpo_layout_responsive') != 0)
...
require_once($core_path.'shortcodes/shortcode_columns.php');
