...
class Cpotheme_Widget_Advert extends WP_Widget{
	...
	function Cpotheme_Widget_Advert(){
		$widget_ops = array('classname' => 'cpotheme_advert', 'description' => __('This widget lets you display an advertising banner of any size.', 'cpocore'));
		$this->WP_Widget('cpotheme-advert', __('CPO - Ad Space', 'cpocore'), $widget_ops);
		$this->alt_option_name = 'cpotheme_advert';
	}
	...
	function widget($args, $instance){
		...
		<div class="advert" id="advert-<?php echo $widget_id; ?>">
			<?php if($ad_code == ''): ?>
